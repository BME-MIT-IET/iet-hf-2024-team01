...
public class JatekPanel extends JPanel {
    ...
    public JatekPanel(){
        ...
        jatekosJon.setFont(new Font(fontName,Font.BOLD,20));
        ...
        jatekosLepesek.setFont(new Font(fontName,Font.BOLD,20));
        ...
        if(j.getjJatekosN()!=null){
            jatekosJon.setText(j.getjJatekosN() + canStep);
            jatekosLepesek.setText(stepsRemain + j.getjJatekosN().getLepes());
        }
        if(j.getjJatekosSz()!=null){
            jatekosJon.setText(j.getjJatekosSz() + canStep);
            jatekosLepesek.setText(stepsRemain + j.getjJatekosSz().getLepes());
        }

        nomadPont = new JTextField("Nomádok pontjai: "+j.getNomadPontok());
        nomadPont.setOpaque(false);
        nomadPont.setFont(new Font(fontName,Font.BOLD,20));
        ...
        szereloPont.setFont(new Font(fontName,Font.BOLD,20));
    ...
    public void Start(){
        ...
        if(getJatek().getjJatekosN()!=null){
            jatekosJon.setText(getJatek().getjJatekosN().getNev() + canStep);
            jatekosLepesek.setText(stepsRemain + j.getjJatekosN().getLepes());
        }
        if(getJatek().getjJatekosSz()!=null){
            jatekosJon.setText(getJatek().getjJatekosSz().getNev() + canStep);
            jatekosLepesek.setText(stepsRemain + j.getjJatekosSz().getLepes());
        }
    ...
    public void paintComponent(Graphics g){
        ...
        if(j.getKorok()>=1)
        {
            ...
            korSzam.setFont(new Font(fontName,Font.BOLD,50));
